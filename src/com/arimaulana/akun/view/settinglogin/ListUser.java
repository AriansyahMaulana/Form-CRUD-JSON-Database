...
import com.arimaulana.akun.tablemodel.UserTableModel;
...
public class ListUser extends javax.swing.JPanel {
    ...
    private UserTableModel tblModel;
    ...
    public ListUser(MainForm frame) {
        initComponents();
        loadData();
        this.mainForm = frame;
    }
    ...
    private void loadData() {
        tblModel = new UserTableModel((List<User>) (Object) service.list());
        tblBbm.setModel(tblModel);
    }
    
    private void cari() {
        tblModel = new UserTableModel((List<User>) (Object) service.listByObject(keys, tfCari.getText()));
        tblBbm.setModel(tblModel);
    }
    
    private void setForm(FormUser form) {
    ...
    private void edit() {
        ...
        setForm(new FormUser(null, true, mainForm, user));
    }
    
    private void tambah() {
        setForm(new FormUser(null, true, mainForm));
    }
    ...
    private void initComponents() {
        ...
        btnTambah.setText("Tambah User Baru");
        ...
        jLabel2.setText("Daftar Data User");
