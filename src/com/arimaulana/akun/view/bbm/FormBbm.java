 ...
 */
package com.arimaulana.akun.view.bbm;

import com.arimaulana.akun.domain.Bbm;
import com.arimaulana.akun.service.BbmService;
 ...
 * @author AriMaulana99
 */
public class FormBbm extends javax.swing.JDialog {

    private final BbmService service = new BbmService();
    private MainForm mainForm;
    private boolean save = true;
    private Bbm bbm = new Bbm(); 
    private final String titleTambah = "Tambah Akun " + bbm.getClass().getSimpleName() + " Baru";
    private final String titleEdit = "Edit Akun " + bbm.getClass().getSimpleName();
     ...
     * @param modal
     */
    public FormBbm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public FormBbm(java.awt.Frame parent, boolean modal, MainForm frame) {
        super(parent, modal);
        initComponents();
        this.mainForm = frame;
    ...
    public FormBbm(java.awt.Frame parent, boolean modal, MainForm frame, Bbm bbm) {
        super(parent, modal);
        initComponents();
        this.mainForm = frame;
    ...
    private void reloadList() {
        Utils.setContent(mainForm, new ListBbm(mainForm));
    }

    private Bbm getObject() {
        Bbm obj = new Bbm();
        if (!save) {
            obj.setId(bbm.getId());
        }
    ...
    private void initComponents() {
        ...
        tfPin.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tfPin.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        tfPin.setMargin(new java.awt.Insets(2, 10, 2, 2));
        tfPin.setPreferredSize(new java.awt.Dimension(59, 30));

        jLabel3.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel3.setText("PIN BBM");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tfPin, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBbm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormBbm dialog = new FormBbm(new javax.swing.JFrame(), true);
