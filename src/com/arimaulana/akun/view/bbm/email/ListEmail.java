...
import com.arimaulana.akun.tablemodel.EmailTableModel;
 ...
 * @author AriMaulana99
 */
public class ListEmail extends javax.swing.JPanel {

    private EmailTableModel tblModel;
    private final EmailService service = new EmailService();
    private MainForm mainForm;
    private final String[] keys = {"id", "namaEmail", "password", "pertanyaanRahasia"};
    ...
    public ListEmail(MainForm frame) {
        initComponents();
        loadData();
        this.mainForm = frame;
    }
    ...
    private void loadData() {
        tblModel = new EmailTableModel((List<Email>) (Object) service.list());
        tblBbm.setModel(tblModel);
    }
    
    private void cari() {
        tblModel = new EmailTableModel((List<Email>) (Object) service.listByObject(keys, tfCari.getText()));
        tblBbm.setModel(tblModel);
    }
    
    private void setForm(FormEmail form) {
    ...
    private void edit() {
        ...
        Email email = (Email) service.get(id);
        setForm(new FormEmail(null, true, mainForm, email));
    }
    
    private void tambah() {
        setForm(new FormEmail(null, true, mainForm));
    }
    ...
    private void initComponents() {
        ...
        btnTambah.setText("Tambah Akun Email Baru");
        ...
        jLabel2.setText("Daftar Data Email");
