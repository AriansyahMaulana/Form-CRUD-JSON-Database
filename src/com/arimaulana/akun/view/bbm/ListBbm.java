...
import com.arimaulana.akun.tablemodel.BbmTableModel;
 ...
 * @author AriMaulana99
 */
public class ListBbm extends javax.swing.JPanel {

    private BbmTableModel tblModel;
    private final BbmService service = new BbmService();
    private MainForm mainForm;
    private final String[] keys = {"id", "nama", "email", "pin", "password"};
    ...
    private void loadData() {
        tblModel = new BbmTableModel((List<Bbm>) (Object) service.list());
        tblBbm.setModel(tblModel);
    }
    
    private void cari() {
        tblModel = new BbmTableModel((List<Bbm>) (Object) service.listByObject(keys, tfCari.getText()));
        tblBbm.setModel(tblModel);
    }
    
    private void setForm(FormBbm form) {
    ...
    private void edit() {
        ...
        Bbm bbm = (Bbm) service.get(id);
        setForm(new FormBbm(null, true, mainForm, bbm));
    }
    
    private void tambah() {
        setForm(new FormBbm(null, true, mainForm));
    }
    ...
    private void initComponents() {
        ...
        btnTambah.setText("Tambah Akun Bbm Baru");
        ...
        jLabel2.setText("Daftar Data BBM");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnTambah, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
