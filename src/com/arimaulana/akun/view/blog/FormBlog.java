 ...
 */
package com.arimaulana.akun.view.blog;
 ...
 * @author AriMaulana99
 */
public class FormBlog extends javax.swing.JDialog {

    private final BlogService service = new BlogService();
    private MainForm mainForm;
    private boolean save = true;
    private Blog blog = new Blog();
    private final String titleTambah = "Tambah Akun " + blog.getClass().getSimpleName() + " Baru";
    private final String titleEdit = "Edit Akun " + blog.getClass().getSimpleName();
     ...
     * @param modal
     */
    public FormBlog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public FormBlog(java.awt.Frame parent, boolean modal, MainForm frame) {
        super(parent, modal);
        initComponents();
        this.mainForm = frame;
    ...
    public FormBlog(java.awt.Frame parent, boolean modal, MainForm frame, Blog blog) {
        super(parent, modal);
        initComponents();
        this.mainForm = frame;
    ...
    private void reloadList() {
        Utils.setContent(mainForm, new ListBlog(mainForm));
    }

    private Blog getObject() {
        Blog obj = new Blog();
        if (!save) {
    ...
    private void setObject(Blog obj) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBlog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormBlog dialog = new FormBlog(new javax.swing.JFrame(), true);
