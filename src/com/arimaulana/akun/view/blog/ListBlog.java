 ...
 * @author AriMaulana99
 */
public class ListBlog extends javax.swing.JPanel {

    private BlogTableModel tblModel;
    private final BlogService service = new BlogService();
    private MainForm mainForm;
    private final String[] keys = {"id", "nama", "email", "url"};
    ...
    public ListBlog(MainForm frame) {
        initComponents();
        loadData();
        this.mainForm = frame;
    }
    ...
    private void loadData() {
        tblModel = new BlogTableModel((List<Blog>) (Object) service.list());
        tblBbm.setModel(tblModel);
    }
    
    private void cari() {
        tblModel = new BlogTableModel((List<Blog>) (Object) service.listByObject(keys, tfCari.getText()));
        tblBbm.setModel(tblModel);
    }
    
    private void setForm(FormBlog form) {
    ...
    private void edit() {
        ...
        Blog blog = (Blog) service.get(id);
        setForm(new FormBlog(null, true, mainForm, blog));
    }
    
    private void tambah() {
        setForm(new FormBlog(null, true, mainForm));
    }
    ...
    private void initComponents() {
        ...
        btnTambah.setText("Tambah Akun Blog Baru");
        ...
        jLabel2.setText("Daftar Data Blog");
